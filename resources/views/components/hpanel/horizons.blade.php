...
<section x-data="horizons()" x-init="init()" class="reveal">
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    {{-- Title + breadcrumb --}}
    <div class="mb-5">
      <h1 class="text-xl sm:text-2xl font-semibold text-gray-900">Horizons</h1>
    ...
    <section class="mt-8 grid md:grid-cols-3 gap-6">
      ...
      @foreach ($features as $f)
        <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow hover:shadow-lg transition will-change-transform hover:-translate-y-0.5">
          <div class="flex items-center gap-3">
            <div class="h-10 w-10 grid place-items-center rounded-xl bg-indigo-600/10 text-indigo-600">
    ...
    <section class="mt-8 rounded-2xl border border-gray-200 bg-white p-5 sm:p-6">
      ...
      <div class="mt-4 grid md:grid-cols-3 gap-4 text-sm">
        <div class="rounded-xl border border-gray-200 p-4">
          <div class="text-xs font-semibold text-indigo-600">Step 1</div>
          <div class="mt-1 font-medium text-gray-900">Describe your idea</div>
          <p class="mt-1 text-gray-600">Tell Horizons what you want—brand, sections, tone.</p>
        </div>
        <div class="rounded-xl border border-gray-200 p-4">
          <div class="text-xs font-semibold text-indigo-600">Step 2</div>
          <div class="mt-1 font-medium text-gray-900">Get an editable draft</div>
          <p class="mt-1 text-gray-600">AI scaffolds responsive pages. Tweak visually.</p>
        </div>
        <div class="rounded-xl border border-gray-200 p-4">
          <div class="text-xs font-semibold text-indigo-600">Step 3</div>
          <div class="mt-1 font-medium text-gray-900">Publish in one click</div>
          <p class="mt-1 text-gray-600">Connect a domain and go live with rollback.</p>
        </div>
      </div>
    </section>
    ...
    <div id="faq" class="reveal mt-14">
      <div class="mx-auto max-w-7xl">
        ...
        <div class="mt-6 rounded-xl border border-gray-200/70
          ...
          @foreach ($faqs as $f)
            <details class="group border-b border-gray-200/70 last:border-0 transition-colors">
