...
<head>
    ...
    <style>
        ...
        @media (min-width: 640px) {
            ...
            /* Sidebar width + main offset controlled by ONE variable */
            body {
            ...
            /* Hover expand only when collapsed: overlay only, no main shift */
            ...
            /* Label hide/show smoothly (instead of display:none) */
            ...
            body.sidebar-hover .sidebar-label,
...
<body class="h-full bg-gray-50 dark:bg-gray-900">
    ...
    <script>
        ...
        // Sidebar: mobile slide + desktop mini + hover expand + pinned toggle
        (function() {
